...
def round1():
    ...
    while(1):
        ...
        if "GP交換" in re_OK:
            ...
            random_y_offset = random.randint(442, 460)
            start_abs_x = window_pos[0] + random_x_offset
            start_abs_y = window_pos[1] + random_y_offset
            pyautogui.moveTo(start_abs_x, start_abs_y, duration=random.randint(1, 3))
            pyautogui.mouseDown()
...
def round0():
    time.sleep(random.randint(3, 5))
    while(1):
        re_OK = get_text_from_game_region(window_pos[0], window_pos[1],30,24,65-24,50-30)
        print(re_OK)
    # while(1):
    #     re_OK = get_text_from_game_region(window_pos[0], window_pos[1],39,616,678-616,62-40)
    #     print(re_OK)
    #     # time.sleep(random.randint(4, 4))
    # if "立即完成" in re_OK:
    #     random_x_offset = random.randint(616, 678)
    #     random_y_offset = random.randint(39, 62)
    #     start_abs_x = window_pos[0] + random_x_offset
    #     start_abs_y = window_pos[1] + random_y_offset
    #     pyautogui.moveTo(start_abs_x, start_abs_y, duration=random.randint(1, 3))
    #     pyautogui.mouseDown()
    ...
    # re_OK = get_text_from_game_region(window_pos[0], window_pos[1],385,262,350-262,415-385)
    # print(re_OK)
    # if "掃蕩" in re_OK:
    #     random_x_offset = random.randint(262, 350)
    #     random_y_offset = random.randint(385, 415)
    #     start_abs_x = window_pos[0] + random_x_offset
    #     start_abs_y = window_pos[1] + random_y_offset
    #     pyautogui.moveTo(start_abs_x, start_abs_y, duration=random.randint(1, 3))
    #     pyautogui.mouseDown()
    ...
    #     random_x_offset = random.randint(480, 532)
    #     random_y_offset = random.randint(420, 430)
    #     start_abs_x = window_pos[0] + random_x_offset
    #     start_abs_y = window_pos[1] + random_y_offset
    #     pyautogui.moveTo(start_abs_x, start_abs_y, duration=random.randint(1, 3))
    #     pyautogui.mouseDown()
    ...
    #     random_x_offset = random.randint(380, 430)
    #     random_y_offset = random.randint(360, 380)
    #     start_abs_x = window_pos[0] + random_x_offset
    #     start_abs_y = window_pos[1] + random_y_offset
    #     pyautogui.moveTo(start_abs_x, start_abs_y, duration=random.randint(1, 3))
    #     pyautogui.mouseDown()
